...
export default ({selectedLength,deleteItems,setOpen,setEditStage,setOpenCols,setShow,input, setInput,setSearchDialog})=>{
    ...
    <Stack flexDirection={'row'} alignItems="center"  sx={{borderBottom:'1px solid #eee',padding:'1rem',backgroundColor:'#fff'}} component={Toolbar}>
      ...
      <SearshBox setOpen={handleOpenSearchDialog} />
    </Stack>
  )}